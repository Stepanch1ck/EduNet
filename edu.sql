...
--
-- Хост: localhost:3306
-- Время создания: Мар 30 2024 г., 20:06
...
(1, 'Фамилия', 'Имя', 'Отчество', NULL, 321, 'Эл. почта', '3645', 'История'),
...
INSERT INTO `exam` (`ID`, `Subject`, `Score1Sem`, `Score2Sem`) VALUES
(1, 'Разработка приложений на c#', 43, 37),
(2, 'Математический анализ', 38, 40),
(3, 'Алгебра и геометрия', 47, 38);
...
(1, 'Степанова', 'Анастасия', 'Алексеевна', NULL, 321, 'настя', '1234'),
(2, 'Чуркин', 'Степан', 'Сергеевич', NULL, 321, 'стёпа', '5678'),
(3, 'Каримов', 'Адель', 'Ильдарович', NULL, 322, 'адель', '7890'),
(4, 'Сащикова', 'Елизавета', 'Сергеевна', NULL, 321, 'лиза', '3004');
